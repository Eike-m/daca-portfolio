...
# INTEGRATSIOONIKONTROLL:
# [x] visualize_export.py aktsepteerib Roll B väljundit
# [x] df_weekly veerud sobivad Plotly diagrammile
# [x] KPI dictionary võtmed sobivad KPI summary funktsioonile
